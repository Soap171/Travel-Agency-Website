  ...
  return (
    <div className="relative min-h-screen pt-28 pb-20 px-4 md:px-6 bg-background-luxe text-foreground-luxe">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        ...
        <div className="glass-panel p-6 md:p-8 rounded-3xl border-white/5 bg-gradient-to-r from-primary via-slate-900 to-[#090d16] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-accent uppercase tracking-widest font-bold">Horizon VIP Concierge</span>
              <h1 className="font-serif text-2xl md:text-3xl font-bold text-white tracking-tight leading-none mt-1">
                Alexander Vanderbilt
              </h1>
              <span className="text-xs text-slate-400 font-sans mt-1">Status: Lifetime Platinum Explorer</span>
            </div>
          </div>
              ...
              <AnimatePresence mode="wait">
                {activeTrip ? (
                  ...
                  >
                    ...
                    <div className="glass-panel rounded-3xl border-slate-200 dark:border-white/5 overflow-hidden shadow-2xl bg-white/40 dark:bg-slate-950/10">
